## ushaikh-react-native-bottom-bar
A high performance, beautiful and fully customizable curved bottom navigation bar for React Native.
## Getting started
```js
    npm install ushaikh-react-native-bottom-bar react-native-svg --save
```
or
```js
    yarn add ushaikh-react-native-bottom-bar react-native-svg
```
...
```javascript
    ...
    import { CurvedBottomBar } from 'ushaikh-react-native-bottom-bar';
